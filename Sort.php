    ...
    <nav aria-label="Page navigation example">
     <?php 
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            if($page>1){
                echo '<li class="page-item"><a class="page-link" href="/elibrary/Sort.php?page='.($page-1).'&ord='.($ord).'">&laquo;</a></li>';
            }
            ...
            {  if($i==$page)
               ...
               echo ' <li class="page-item '.$active.'"><a class="page-link" href="/elibrary/Sort.php?page='.$i.'&ord='.($ord).'">'.$i.'</a></li> ';
            }
            if($total_page>$page){
            echo'<li class="page-item"><a class="page-link" href="/elibrary/Sort.php?page='.($page+1).'&ord='.($ord).'">&raquo;</a></li>';
            }
            echo '</ul>';
        }
    ?>
