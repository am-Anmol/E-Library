...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container-fluid ">
            <a class="navbar-brand" href="/elibrary/index.php">
                <img src="img/logo.svg" alt="" width="30" height="30" class="d-inline-block align-text-top fs-4" onclick="window.location.href='/index.php';">
                E-Library
            </a>
            ...
            <div class="collapse navbar-collapse " id="navbarNavDropdown">
                <div class="navbar-nav me-auto mb-1 mb-lg-0">
                    <div class="dropdown">
                        ...
                        <li><a class="dropdown-item text-center"  href="/elibrary/Sort_Book.php?ord=ASC">A-Z</a></li>
                        <li><a class="dropdown-item text-center"  href="/elibrary/Sort_Book.php?ord=DESC">Z-A</a></li>
                        </ul>
                    </div>
                </div>
                    <form class="d-flex " action="/elibrary/Search_Book.php" method="GET">
    ...
    <div class="container ">
        <div class='row row-cols-1 row-cols-md-3 g-5 mt-2 '>
          <?php 
            $sq="SELECT * FROM `books` ORDER BY ISBN DESC LIMIT $offset,$limit ";
                ...
                { 
                    ...
                    <div class='card-body '>
                        ...
                        <div class='card-footer bg-transparent border-dark'>
                            <div class='card-body'>
                                <a href='/elibrary/View_Book_Details.php?ISBN=". $row['ISBN'] ." '  class='card-link' style='text-decoration:none'>View</a>
                            </div>
                        </div>
                    </div>
                </div>";
