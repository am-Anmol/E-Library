                ...
                { 
                    ...
                    <div class='card-body '>
                        ...
                        <div class='card-footer bg-transparent border-dark'>
                            <div class='card-body'>
                                <a href='/elibrary/View_Book_Details.php?ISBN=". $row['ISBN'] ." '  class='card-link'>Veiw</a>
                            </div>
                        </div>
                    </div>
                </div>";
     ...
     <nav aria-label="Page navigation example">
      <?php 
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            if($page>1){
                echo '<li class="page-item"><a class="page-link" href="/elibrary/Search_Book.php?Search='.($Search).'&page='.($page-1).'">&laquo;</a></li>';
            }
            ...
            {  if($i==$page)
               ...
               echo ' <li class="page-item '.$active.'"><a class="page-link" href="/elibrary/Search_Book.php?Search='.($Search).'&page='.$i.'">'.$i.'</a></li> ';
            }
            if($total_page>$page){
            echo'<li class="page-item"><a class="page-link" href="/elibrary/Search_Book.php?Search='.($Search).'&page='.($page+1).'">&raquo;</a></li>';
            }
            echo '</ul>';
        }
    ?>
